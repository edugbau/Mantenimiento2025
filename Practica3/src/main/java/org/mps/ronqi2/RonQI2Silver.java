...
public class RonQI2Silver extends RonQI2{
    ...
    */
    public void obtenerNuevaLectura(){
        ...
        lecturasS.add(disp.leerSensorSonido()); // Debe leer el sonido no la presion
    ...
    */
    ...
    public boolean evaluarApneaSuenyo() {
        ...
        if (avgP > thresholdP && avgS > thresholdS){ // debe ser >thresholdP y no >=thresholdP
            resultado = true; // se ha cambiado para que devuelva true cuando sobrepasa el umbral
        }   
        else{
            resultado = false;
        }
