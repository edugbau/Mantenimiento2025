...
public class RonQI2Silver extends RonQI2{
    ...
    */
    public void obtenerNuevaLectura(){
        ...
        lecturasS.add(disp.leerSensorPresion()); // TODO Debe leer el sonido no la presion
    ...
    */
    ...
    public boolean evaluarApneaSuenyo() {
        ...
        if (avgP>=thresholdP && avgS > thresholdS){ // TODO este debe devolver true (según el comentario) tendria que ser ||?
