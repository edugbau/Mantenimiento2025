...
public class ArrayBoundedQueueTest {
    ...
    // GET
    @Test
    @DisplayName("Get: Lanza excepción al intentar obtener un elemento de una cola vacía")
    ...
    @Test
    @DisplayName("Get: Devuelve el único elemento y deja la cola vacía")
    ...
    @Test
    @DisplayName("Get: Devuelve el primer elemento y actualiza índices correctamente")
    ...
    @Test
    @DisplayName("Get: Devuelve el primer elemento de una cola llena y actualiza índices")
    ...
    @Test
    @DisplayName("Get: Devuelve el segundo elemento tras un get y actualiza índices")
    ...
    @Test
    @DisplayName("Get: Devuelve el tercer elemento original tras wrap-around y actualiza índices")
    ...
    @Test
    @DisplayName("Get: Devuelve el último elemento tras wrap-around y deja la cola vacía")
